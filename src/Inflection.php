...
class Inflection
  {
    ...
    protected $patterns = [
      ...
      // město
      ["s", "město", "města", "městu", "město", "město", "městě", "městem", "města", "měst", "městům", "města", "města", "městech", "městy"],
      // clo
      ...
      // obec
      ["f", "obec", "obce", "obci", "obec", "obci", "obci", "obcí", "obce", "obcí", "obcím", "obce", "obce", "obcích", "obcemi"],
      // Třeboň
